...
import type { File, Folder as FolderType } from "~/lib/mock-data"

export function FolderRow({ folder, handleFolderClick }: { folder: FolderType, 
                    ...
                    <div className="col-span-6 flex items-center">
                        {
                            <a href={file.url} className="flex items-center text-gray-100 hover:text-blue-400">
                                <FileIcon className="mr-3" size={20} target="_blank" />
                                {file.name} 
                            </a>
                        }
                    </div>
